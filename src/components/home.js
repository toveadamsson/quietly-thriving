    ...
    <div className="home-page">
      ...
      <div className="contact">
        <div className="text">
          <div>
            <p>
              Are you feeling stuck in your career/ holding yourself back
              because of your more quiet nature? Or are you struggling with
              socializing or about to start your own business, but you’re
              feeling too overwhelmed?
            </p>
            <p>Book a first 30 minutes free call.</p>
          </div>
        ...
        <div className="text">
          <div>
            <p>
              Join the community on Facebook. A safe space for like-minded
              women. Introverted women who are on a journey of personal growth.
            </p>
